<template>
    <div>
        ...
        <div class="rankListContent" v-if="isRequest||(list&&list.length)">
            ...
            <ul class="rankListItemWrap">
                <li class="flex item flex-align-center" v-for="(item, index) in list" :key="index">
                    <div class="num">
                        {{item.rank}}
                    </div>
                    <div class="player flex-align-center flex">
                        <img :src="item.playerLogo">
                        <span>
                            {{item.playerName}}
                        </span>
                    </div>
